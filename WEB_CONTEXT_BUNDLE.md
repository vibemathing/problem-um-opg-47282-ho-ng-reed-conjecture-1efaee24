...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-47282-ho-ng-reed-conjecture-1efaee24-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-47282"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-47282-ho-ng-reed-conjecture-1efaee24-v1",
      "problem_contract_sha256": "2bc4bd797850ea621a9ea044a60b3a52cf37c7cf44762eb3a1e967a967ba9a00",
      "problem_id": "problem:um-opg-47282-ho-ng-reed-conjecture-1efaee24",
      "route_id": "route:um-opg-47282-ho-ng-reed-conjecture-1efaee24-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-47282-ho-ng-reed-conjecture-1efaee24-source-fidelity-01",
      "graph_id": "graph:um-opg-47282-ho-ng-reed-conjecture-1efaee24-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-47282-ho-ng-reed-conjecture-1efaee24-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-47282-ho-ng-reed-conjecture-1efaee24-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture Every digraph in which each vertex has outdegree at least $k$ contains $k$ directed cycles $C_1, \\ldots, C_k$ such that $C_j$ meets $\\cup_{i=1}^{j-1}C_i$ in at most one vertex, $2 \\leq j \\leq k$."
          },
          "statement_sha256": "31321978a96201192a99312a61de79a8fe1d3a760e6d8957748f489ee50dc1df"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-47282-ho-ng-reed-conjecture-1efaee24-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-47282-ho-ng-reed-conjecture-1efaee24-root",
      "route_id": "route:um-opg-47282-ho-ng-reed-conjecture-1efaee24-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-47282-a0429a56cf69",
        "url": "https://www.unsolvedmath.com/problems/OPG-47282"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
